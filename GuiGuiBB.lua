local BlackLuaFree = game:GetService("CoreGui"):FindFirstChild('BlackLua Hub : Free')
if BlackLuaFree then
	BlackLuaFree:Destroy()
end

local library = {
	Version = "Test",
	WorkspaceName = "BlackLua Hub : Free",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
	...
	colors = {
		main = Color3.fromHex('6E6E6E'),
		background = Color3.fromRGB(40, 40, 40),
		outerBorder = Color3.fromRGB(15, 15, 15),
		innerBorder = Color3.fromHex('7A7A7A'),
				...
				if getsynasset then
					...
					elseif #image > 14 and string.sub(image, 1, 14) == "synasseturl://" then
						local x, e = pcall(function()
							...
							local fold = isfolder("./Black Lua Free Scripts")
							if not fold then
								makefolder("./Black Lua Free Scripts")
							end
							fold = isfolder("./Black Lua Free Scripts/Themes")
							if not fold then
								makefolder("./Black Lua Free Scripts/Themes")
							end
							fold = isfolder("./Black Lua Free Scripts/Themes/SynapseAssetsCache")
							if not fold then
								makefolder("./Black Lua Free Scripts/Themes/SynapseAssetsCache")
							end
							if not fold or not isfile("./Black Lua Free Scripts/Themes/SynapseAssetsCache/" .. codename .. ".dat") then
								local res = game:HttpGet(string.sub(image, 15))
								if res ~= nil then
									writefile("./Black Lua Free Scripts/Themes/SynapseAssetsCache/" .. codename .. ".dat", res)
								end
							end
							return getsynasset(readfile("./Black Lua Free Scripts/Themes/SynapseAssetsCache/" .. codename .. ".dat"))
						end)
						if x and e ~= nil then
							return e
						end
...
function library:CreateWindow(options, ...)
	...
	pepsiLibrary.Name = "BlackLua : Free Src"
		...
		function tabFunctions:CreateSection(options, ...)
			...
			function sectionFunctions:AddButton(...)
				...
				for _, options in next, args do
					...
					button.Image = "rbxassetid://9538090191"
					...
					buttonInner.Image = "rbxassetid://9538090191"
			...
			function sectionFunctions:AddSlider(options, ...)
				...
				slider.Image = "rbxassetid://9538090191"
				...
				sliderInner.Image = "rbxassetid://9538090191"
				...
				sliderColored.Image = "rbxassetid://9538090191"
			...
			function sectionFunctions:AddSearchBox(options, ...)
				...
				dropdown.Image = "rbxassetid://9538090191"
				...
				dropdownInner.Image = "rbxassetid://9538090191"
				...
				dropdownHolderFrame.Image = "rbxassetid://9538090191"
				...
				dropdownHolderInner.Image = "rbxassetid://9538090191"
				...
				local function AddOptions(optionsTable, filter)
					...
					for _, v in next, optionsTable do
						if not filter or tostring(v):lower():find(dropdownSelection.Text:lower(), 1, not options.RegEx) then
							...
							newOption.Image = "rbxassetid://9538090191"
			...
			function sectionFunctions:AddColorpicker(options, ...)
				...
				colorPicker.Image = "rbxassetid://9538090191"
				...
				colorPickerInner.Image = "rbxassetid://9538090191"
				...
				colorPickerHolderFrame.Image = "rbxassetid://9538090191"
				...
				colorPickerHolderInner.Image = "rbxassetid://9538090191"
				...
				hexInput.Image = "rbxassetid://9538090191"
				...
				hexInputInner.Image = "rbxassetid://9538090191"
				...
				randomColor.Image = "rbxassetid://9538090191"
				...
				randomColorInner.Image = "rbxassetid://9538090191"
				...
				rainbow.Image = "rbxassetid://9538090191"
				...
				rainbowInner.Image = "rbxassetid://9538090191"
